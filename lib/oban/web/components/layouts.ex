defmodule Oban.Web.Layouts do
  ...
  def logo(assigns) do
    ~H"""
    <a
      href={@path || oban_path(:jobs)}
      title="Oban Web"
      class="inline-block rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
    >
      <svg aria-hidden="true" class="h-10 overflow-visible" viewBox="0 0 227 64">
        <path
          ...
          <div class="flex items-center">
            ...
            <div class="ml-4 flex-shrink-0 flex">
              <button
                ...
                phx-value-key={@kind}
                class="inline-flex rounded-md text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
              >
  ...
  def nav(assigns) do
    ~H"""
    <nav aria-label="Main" class="flex space-x-2">
      <.link
        :for={page <- [:jobs, :queues, :crons, :pruners, :workflows]}
  ...
  def footer(assigns) do
    ...
    <footer class="flex flex-col px-3 py-6 text-sm justify-center items-center md:flex-row">
      ...
      <a
        href="https://oban.pro"
        class="flex items-center space-x-2 group rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
      >
  ...
  defp link_class(curr, page) do
    base =
      "font-semibold text-sm rounded-md px-3 py-2" <>
