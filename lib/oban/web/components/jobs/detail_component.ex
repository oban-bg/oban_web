      ...
      <div class="flex justify-between items-center px-3 py-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <div class="flex">
          <%= if can?(:cancel_jobs, @access) and cancelable?(@job) do %>
            ...
            >
              <svg
                class="-ml-1 mr-1 h-5 w-5 text-gray-500 group-hover:text-yellow-500"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
          ...
          <%= if can?(:retry_jobs, @access) and runnable?(@job) do %>
            ...
            >
              <svg
                class="-ml-1 mr-1 h-5 w-5 text-gray-500 group-hover:text-blue-500"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
          ...
          <%= if can?(:retry_jobs, @access) and retryable?(@job) do %>
            ...
            >
              <svg
                class="-ml-1 mr-1 h-5 w-5 text-gray-500 group-hover:text-blue-500 dark:group-hover:text-blue-400"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
          ...
          <%= if can?(:delete_jobs, @access) and deletable?(@job) do %>
            ...
            >
              <svg
                class="-ml-1 mr-1 h-5 w-5 text-gray-500 group-hover:text-red-500"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
