      ...
      <div class="flex justify-between items-center px-3 py-4 border-b border-gray-200">
        ...
        <div class="flex">
          <%= if cancelable?(@job) do %>
            <a href="#"
               class="group flex items-center ml-4 text-sm text-gray-600 bg-white px-4 py-2 border border-gray-300 rounded-md focus:outline-none hover:text-blue-600 hover:border-blue-700"
          ...
          <%= if runnable?(@job) do %>
            <a href="#"
               class="group flex items-center ml-3 text-sm text-gray-600 bg-white px-4 py-2 border border-gray-300 rounded-md focus:outline-none hover:text-blue-600 hover:border-blue-700"
          ...
          <%= if deletable?(@job) do %>
            <a href="#"
               class="group flex items-center ml-3 text-sm text-gray-600 bg-white px-4 py-2 border border-gray-300 rounded-md focus:outline-none hover:text-red-600 hover:border-red-700"
