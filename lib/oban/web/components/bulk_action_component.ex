defmodule Oban.Web.BulkActionComponent do
  ...
  def render(assigns) do
    ~L"""
    <div id="bulk-action" class="flex items-center bg-white dark:bg-gray-900 shadow-inner overflow-hidden transition-all duration-300 ease-in-out px-3 <%= if @expanded? do %>h-12 py-3 bg-gray-100 dark:bg-gray-800<% else %>h-0<% end %>">
