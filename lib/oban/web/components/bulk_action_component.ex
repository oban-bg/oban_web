defmodule Oban.Web.BulkActionComponent do
  ...
  def render(assigns) do
    ~L"""
    <div id="bulk-action" class="flex items-center bg-white shadow-inner overflow-hidden transition-all duration-300 ease-in-out px-3 <%= if @expanded? do %>h-12 py-3 bg-gray-100<% else %>h-0<% end %>">
