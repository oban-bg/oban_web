  ...
  def render(assigns) do
    ...
    <main role="main" class="p-4">
      ...
      <footer class="flex flex-col px-3 pb-6 text-sm justify-center items-center md:flex-row">
        <span class="text-gray-600 tabular mr-0 mb-1 md:mr-3 md:mb-0">Oban v<%= Oban.version() %></span>
        <span class="text-gray-600 tabular mr-0 mb-1 md:mr-3 md:mb-0">Oban.Web v<%= Oban.Web.version() %></span>
        <span class="text-gray-600 tabular mr-0 mb-3 md:mr-3 md:mb-0">Oban.Pro v<%= Oban.Pro.version() %></span>
