  ...
  def render(assigns) do
    ...
    <main class="p-4">
      ...
      <footer class="flex flex-col px-3 pb-6 text-sm justify-center items-center md:flex-row">
        <span class="text-gray-600 tabular mr-0 mb-1 md:mr-3 md:mb-0">Oban v<%= Application.spec(:oban, :vsn) %></span>
        <span class="text-gray-600 tabular mr-0 mb-1 md:mr-3 md:mb-0">Oban.Web v<%= Application.spec(:oban_web, :vsn) %></span>
        <span class="text-gray-600 tabular mr-0 mb-3 md:mr-3 md:mb-0">Oban.Pro v<%= Application.spec(:oban_pro, :vsn) %></span>

        <span class="text-gray-800 mr-1">
        ...
        <span class="text-gray-800 font-semibold">Made by Soren</span>
      </footer>
    </main>
    """
  end
