if Code.ensure_loaded?(Oban.Pro) do
  defmodule Oban.Web.Pro.Pages.Workflows.IndexTest do
    ...
    test "clicking a workflow navigates to detail view", %{live: live} do
      insert_workflow!(workflow_id: "wf-clickable", workflow_name: "clickable-workflow")
    ...
    test "naming compensation workflows after the workflow they roll back", %{live: live} do
    ...
    test "falling back to the origin id once the origin is pruned", %{live: live} do
      saga = run_failed_saga!(workflow_name: "order-fulfillment")
