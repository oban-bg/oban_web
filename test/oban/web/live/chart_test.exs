defmodule Oban.Web.Live.ChartTest do
  ...
  describe "guide_values/2" do
    ...
    test "rounding larger values" do
      assert [_, "130"] = Chart.guide_values(100, 2)
      assert [_, "1.3k"] = Chart.guide_values(1000, 2)
      assert [_, "12.5k"] = Chart.guide_values(10_000, 2)
      assert [_, "125k"] = Chart.guide_values(100_000, 2)
      assert [_, "1.3m"] = Chart.guide_values(1_000_000, 2)
      assert [_, "12.5m"] = Chart.guide_values(10_000_000, 2)
    end
  end
end
